...
public class PickableItemEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        DrawQuestId(serializedObject.FindProperty("_questId"));

        serializedObject.ApplyModifiedProperties();
    }

    static void DrawQuestId(SerializedProperty questId)
    {
        ...
        int selectedIndex = EditorGUILayout.Popup("Quest Id", currentIndex, options.ToArray());
