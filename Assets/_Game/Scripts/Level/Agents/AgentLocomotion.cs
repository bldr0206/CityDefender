...
/// <summary>
/// Общий контекст движения агента: обёртка над NavMeshAgent и аниматором плюс
...
/// </summary>
public sealed class AgentLocomotion
{
    readonly NavMeshAgent _agent;
    readonly AgentAnimator _animator;
    ...
    public void SetAgentEnabled(bool value) => _agent.enabled = value;
